  ...
  return (
    <div className="max-w-xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Thêm trạng thái mới</h1>
          <p className="text-gray-500 text-sm mt-1">Tạo nhãn trạng thái cho tài sản.</p>
        </div>
      </div>
