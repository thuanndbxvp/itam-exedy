...
import { requirePermission, resolvePermissions, invalidatePermissionCache } from '@/lib/permissions'
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (body.action === 'set_custom_role') {
    ...
    return NextResponse.json({ ok: true, data: { customRoleId: customRoleId || null } })
  }
